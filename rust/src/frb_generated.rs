...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1893034895;
...
fn wire__crate__api__init__config_impl(
...
fn wire__crate__api__key__derive_key_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::key::derive_key(api_idx).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__init__set_config_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::init::set_config(api_config);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn wire__crate__api__proxy__start_proxy_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::proxy::start_proxy(&api_origin).await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
impl SseDecode for crate::config::Config {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        let mut var_origin = <Vec<String>>::sse_decode(deserializer);
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__init__config_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__key__derive_key_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__init__init_app_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__init__set_config_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__proxy__start_proxy_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
impl SseEncode for crate::config::Config {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <Vec<String>>::sse_encode(self.origin, serializer);
