...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1893034895;
...
abstract class RustLibApi extends BaseApi {
  Future<void> crateApiInitConfig();

  Future<String> crateApiKeyDeriveKey({required int idx});

  Future<void> crateApiInitInitApp();

  Future<void> crateApiInitSetConfig({required Config config});

  Future<void> crateApiProxyStartProxy({required String origin});
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiInitConfig() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiInitConfigConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiInitConfigConstMeta =>
      const TaskConstMeta(debugName: "config", argNames: []);
  ...
  Future<String> crateApiKeyDeriveKey({required int idx}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiKeyDeriveKeyConstMeta,
        argValues: [idx],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiKeyDeriveKeyConstMeta =>
      const TaskConstMeta(debugName: "derive_key", argNames: ["idx"]);
  ...
  Future<void> crateApiInitSetConfig({required Config config}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiInitSetConfigConstMeta,
        argValues: [config],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiInitSetConfigConstMeta =>
  ...
  Future<void> crateApiProxyStartProxy({required String origin}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiProxyStartProxyConstMeta,
        argValues: [origin],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiProxyStartProxyConstMeta =>
      const TaskConstMeta(debugName: "start_proxy", argNames: ["origin"]);
  ...
  Config sse_decode_config(SseDeserializer deserializer) {
    ...
    var var_origin = sse_decode_list_String(deserializer);
  ...
  void sse_encode_config(Config self, SseSerializer serializer) {
    ...
    sse_encode_list_String(self.origin, serializer);
